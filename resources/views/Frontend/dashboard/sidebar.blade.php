<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
      ...
      <li><a href=""><i class="fal fa-plus-circle"></i> Create Listing</a></li>
      <li><a href=""><i class="far fa-star"></i> Reviews</a></li>
      <li><a href=""><i class="fal fa-notes-medical"></i> Orders</a></li>
      <li><a href=""><i class="fal fa-gift-card"></i> Package</a></li>
      <li><a href=""><i class="far fa-comments-alt"></i> Messages</a></li>
